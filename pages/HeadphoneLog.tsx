...
export const HeadphoneLog: React.FC = () => {
    ...
    const handleExport = () => {
        exportToCSV(sortedLogs, 'headphone-service-logs');
    };
        ...
        <>
            <div className="bg-white p-6 rounded-xl shadow-lg">
                <div className="flex flex-col md:flex-row justify-between md:items-center mb-4 gap-4">
                    <h1 className="text-2xl font-bold text-gray-800">Headphone Service Log</h1>
            ...
            <ImportModal<Partial<PeripheralLogEntry>>
                ...
                assetName="Headphone Logs"
                templateHeaders={['productName', 'serialNumber', 'pcName', 'pcUsername', 'department', 'date', 'time', 'servicedBy', 'comment']}
                exampleRow={['Sony WH-1000XM5', 'SN456789', 'IT-PC-05', 'mike.jones', 'IT', '2024-10-24', '10:00', 'Tech Support', 'Headphone replacement']}
            />
        </>
    );
};
